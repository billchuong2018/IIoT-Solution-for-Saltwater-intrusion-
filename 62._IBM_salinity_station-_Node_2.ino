 ...
 * Developer by Hao N ( Maple Smart Control ) - June 1 - 2020
*/
...
#define MQTT_DEVICEID "d:lshu1o:NodeESP2:Station2" // "d:" ORG ":" DEVICE_TYPE ":" DEVICE_ID;

#define MQTT_USER "use-token-auth"
#define MQTT_TOKEN "xxxxxxxxxxxxxxxx"
#define MQTT_TOPIC "iot-2/evt/station2/fmt/json"
...
void loop() {
  ...
  while (!mqtt.connected()) {
    ...
    get_status();
    status["sal2"] = sal2;
    status["river2"] = river_pump;
    status["farm2"] = farm_pump;    
