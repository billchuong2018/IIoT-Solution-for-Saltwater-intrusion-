 ...
 * Develope by Hao N @ Maple Smart Control - 2020.06.15
*/
...
#define MQTT_HOST "xxxxx.messaging.internetofthings.ibmcloud.com"
#define MQTT_PORT 1883
#define MQTT_DEVICEID "d:xxxxx:NodeESP:Node8266" // "d:" ORG ":" DEVICE_TYPE ":" DEVICE_ID;
//#define MQTT_DEVICEID "NodeESP"
...
void loop() {
  ...
  while (!mqtt.connected()) {
    ...
    get_status();
    status["sal1"] = sal1;
    status["river1"] = river_pump;
    status["farm1"] = farm_pump;    
